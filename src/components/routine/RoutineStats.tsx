...
const RoutineStats = ({ routine }: RoutineStatsProps) => {
  const getDifficultyColor = (difficulty: RoutineDetailType['difficulty']) => {
    switch (difficulty) {
      case 'beginner':
        return 'bg-linear-to-r from-green-100 to-green-50 text-green-800 dark:from-green-900 dark:to-green-800 dark:text-green-200 border-green-200 dark:border-green-700';
      case 'intermediate':
        return 'bg-linear-to-r from-yellow-100 to-yellow-50 text-yellow-800 dark:from-yellow-900 dark:to-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-yellow-700';
      case 'advanced':
        return 'bg-linear-to-r from-red-100 to-red-50 text-red-800 dark:from-red-900 dark:to-red-800 dark:text-red-200 border-red-200 dark:border-red-700';
      default:
        return 'bg-linear-to-r from-cool-100 to-cool-50 text-cool-800 dark:from-cool-900 dark:to-cool-800 dark:text-cool-200 border-cool-200 dark:border-cool-700';
    }
  };
  ...
  return (
    <div className='border-cool-200 dark:border-choco-600 dark:bg-choco-800 space-y-6 rounded-xl border bg-white p-6'>
      ...
      <div className='grid grid-cols-1 gap-4 sm:grid-cols-3'>
        <div className='group relative overflow-hidden rounded-xl bg-linear-to-br from-blue-50 to-blue-100 p-6 dark:from-blue-900/20 dark:to-blue-800/20'>
        ...
        <div className='group relative overflow-hidden rounded-xl bg-linear-to-br from-purple-50 to-purple-100 p-6 dark:from-purple-900/20 dark:to-purple-800/20'>
          <div className='flex items-center gap-4'>
        ...
        <div className='group relative overflow-hidden rounded-xl bg-linear-to-br from-emerald-50 to-emerald-100 p-6 dark:from-emerald-900/20 dark:to-emerald-800/20'>
          <div className='flex items-center gap-4'>
